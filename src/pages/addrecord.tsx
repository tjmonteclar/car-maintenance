...
const AddRecord: React.FC = () => {
  ...
  const validateField = (name: string, value: string) => {
    ...
    switch (name) {
      case "driverName":
        ...
        else if (value.trim().length < 2) newErrors.driverName = "Driver name must be at least 2 characters";
      ...
      case "partType":
        ...
        break;
      case "partCost":
        if (parseFloat(value) < 0) newErrors.partCost = "Cost cannot be negative";
  ...
  const calculateTotalCost = () => {
    return parts.reduce((total, part) => total + parseFloat(part.partCost || "0"), 0);
  };
  ...
  const isFormValid = formData.driverName && formData.carPlate && formData.carModel && parts.length > 0;
  ...
  return (
    <Layout pageTitle="Add Record">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <p className="text-gray-600 mt-2">Create a comprehensive maintenance entry for vehicle service and part replacements</p>
      </div>
          ...
          <div className="bg-gradient-to-r from-gray-50 to-amber-50 px-8 py-6 border-b border-gray-200">
            <div className="flex items-center justify-center space-x-8">
              <div className="flex items-center space-x-3">
                ...
                <span className="font-semibold text-gray-900">Vehicle Info</span>
              </div>
            ...
            <div className="p-8 border-b border-gray-200/60">
              <div className="flex items-center space-x-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Enter the basic information about the vehicle and driver</p>
                </div>
              </div>
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                      <svg className="h-5 w-5 text-gray-400 group-focus-within:text-[#bfa14a]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="p-8">
              <div className="flex items-center space-x-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Add parts that were serviced or replaced</p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-gray-50 to-amber-50/50 p-8 rounded-2xl mb-8 border-2 border-dashed border-[#bfa14a]/40">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                  ...
                  <div className="group">
                    ...
                    {errors.partType && (
                      <p className="mt-2 text-sm text-red-600">{errors.partType}</p>
                    )}
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                  ...
                  <div className="group">
                    ...
                    />
                    {errors.partCost && (
                      <p className="mt-2 text-sm text-red-600">{errors.partCost}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <div className="space-y-4 max-h-96 overflow-y-auto pr-2">
                    {parts.map((part, index) => (
                      <div key={index} className="bg-gradient-to-r from-white to-amber-50/50 p-6 rounded-2xl border border-[#bfa14a]/20 shadow-sm hover:shadow-lg transition-all duration-300 group">
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            {/* Top Row: Part Type and Cost */}
                            <div className="flex items-center justify-between mb-4">
                              <div className="flex items-center space-x-3">
                                <span className="font-bold text-gray-900 text-lg">{part.partType}</span>
                              ...
                              <span className="font-bold text-[#bfa14a] text-xl">${part.partCost}</span>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                              <div className="flex items-center space-x-2">
                                ...
                                <span className="font-semibold text-gray-900">{part.partBrand || 'Not specified'}</span>
                              </div>
                              <div className="flex items-center space-x-2">
                                <span className="text-gray-500 font-medium">Supplier:</span>
                                <span className="font-semibold text-gray-900">{part.supplier || 'Not specified'}</span>
                              </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                              <div>
                                ...
                                <span className="ml-2 font-medium text-gray-900">{part.manufactureDate || 'N/A'}</span>
                              </div>
                              <div>
                                <span className="text-gray-500">Expiry:</span>
                                <span className="ml-2 font-medium text-gray-900">{part.expiryDate || 'N/A'}</span>
                              </div>
                              <div>
                                <span className="text-gray-500">Change Date:</span>
                                <span className="ml-2 font-medium text-gray-900">{part.partChangeDate || 'N/A'}</span>
                              </div>
                            </div>
                          </div>
                          <button
              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
                <div className="text-center lg:text-left">
                  <p className="text-gray-600 mb-1">
                    {parts.length} part{parts.length !== 1 ? 's' : ''} added • Total: ${calculateTotalCost().toFixed(2)}
                  </p>
                  <p className={`text-sm font-medium ${
                    isFormValid ? 'text-green-600' : 'text-amber-600'
                  }`}>
                    {isFormValid ? 'Ready to save maintenance record' : 'Please complete all required fields'}
                  </p>
                </div>
                <button
                  type="submit"
