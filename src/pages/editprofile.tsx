    ...
    <Layout pageTitle="Edit Profile">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-gray-50 to-gray-100 px-8 py-6 border-b border-gray-200 rounded-2xl p-8 text-center mb-8 shadow-lg">
          ...
          <p className="text-gray-500 text-lg">Update your personal information and preferences</p>
        </div>
          ...
          <div className="bg-gradient-to-r from-gray-50 to-gray-100 px-8 py-6 border-b border-gray-200">
            <div className="flex items-center justify-between">
              ...
              <div className="bg-white px-4 py-2 rounded-full border border-[#bfa14a] shadow-sm">
                <span className="text-sm font-semibold text-[#bfa14a]">Personal</span>
              </div>
            </div>
          </div>
        ...
        <div className="mt-8 bg-gradient-to-r from-amber-50 to-yellow-50 rounded-2xl p-6 border border-amber-200">
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-amber-900 mb-2">Profile Information</h3>
              <p className="text-amber-700">
                Keep your profile information up to date to ensure the best experience with our maintenance management system.
                Your data is securely stored and only used to personalize your experience.
              </p>
            </div>
          </div>
        </div>
