        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <div className="flex justify-center mb-2">
            <div className="flex items-center transform hover:scale-105 transition-transform duration-300">
              ...
              <h1 className="ml-4 text-3xl font-bold text-white" style={{ fontFamily: "Tahoma" }}>
                SUPER WHEELS
              </h1>
            </div>
          </div>
          
          <h2 className="text-center text-3xl font-extrabold text-white" style={{ fontFamily: "Tahoma" }}>
            Create Your Account
          </h2>
          <p className="mt-2 text-center text-sm text-white/80" style={{ fontFamily: "Tahoma" }}>
        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
          <div className="bg-white/90 backdrop-blur-lg py-8 px-6 shadow-2xl sm:rounded-2xl border border-white/20">
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                <label htmlFor="name" className="block text-sm font-medium text-gray-700 mb-2" style={{ fontFamily: "Tahoma" }}>
                  Full Name
                </label>
                <div className="relative">
                  <input
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500" style={{ fontFamily: "Tahoma" }}>Must be at least 6 characters long</p>
              </div>

              <div>
                <label htmlFor="confirmPassword" className="block text-sm font-medium text-gray-700 mb-2" style={{ fontFamily: "Tahoma" }}>
                  Confirm Password
                </label>
                <div className="relative">
                  <input
