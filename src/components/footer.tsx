        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 text-sm mb-4 max-w-md font-['Tahoma']">
              Streamline your vehicle maintenance operations with our
              comprehensive management system. Track records, manage parts, and
              optimize your maintenance workflow.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  href="/help-center"
                  className="text-gray-300 hover:text-[#bfa14a] transition-colors duration-200 text-sm flex items-center group font-['Tahoma']"
                >
